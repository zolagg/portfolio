      ...
      <div className="container flex h-14 items-center max-w-screen-2xl mx-auto px-4">
        ...
        <div className="mr-4 hidden md:flex">
          <Link href="/" className="mr-6 flex items-center space-x-2">
            <span className="font-bold text-xl">{basicInfo.name}</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center">
            {basicInfo.socialMedia.map((social) => (
              <Link
                ...
                rel="noreferrer"
                className={cn(
                  "w-9 h-9 flex items-center justify-center rounded-full text-sm font-medium transition-colors hover:bg-muted hover:text-foreground",
                )}
              >
